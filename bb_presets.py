...
OR-Demo-Portfolio, siehe z.B. linehaul_presets.py, quaycrane_presets.py)."""
...
SETTING_SPECS = {
    ...
    "use_strong_bound_toggle": SettingSpec("bound", _bool_caster, C.DEFAULT_USE_STRONG_BOUND),
}
...
def sync_query_params(n_items, capacity_fraction, correlation, seed, use_strong_bound):
    try:
        ...
        st.query_params["bound"] = "1" if use_strong_bound else "0"
    except Exception:
        pass
